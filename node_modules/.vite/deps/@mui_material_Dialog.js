...
import {
  Transition_default
} from "./chunk-LMH7IM3P.js";
import {
  capitalize_default,
  init_capitalize,
  init_useForkRef,
  useForkRef_default
} from "./chunk-E7QENKO2.js";
import {
  HTMLElementType,
  _extends,
...
var Paper = React79.forwardRef(function Paper2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPaper"
  });
...
var DialogContext = React80.createContext({});
if (true) {
...
var Dialog = React81.forwardRef(function Dialog2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiDialog"
  });
  ...
  const backdropClick = React81.useRef();
  ...
  const dialogContextValue = React81.useMemo(() => {
    return {
